"""
Script: action_explorer_v09.py
Version: v09
Description: A custom HTTP web server that provides an interactive directory listing.
v09 fixes:
- create_cbz_direct: replaced 7z with unrar (for .cbr) and unzip (for .cbz),
  matching makecbz.py's approach — fixes RAR5 "Unsupported Method" error
- Rename button: clicking it now cancels the countdown and waits for the user
  to manually click Proceed, so the edited outname is always used
"""
